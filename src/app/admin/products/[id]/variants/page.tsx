    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-zinc-400">管理此商品的所有獎項（A賞、B賞等）</p>
          </div>
          <button
            onClick={() => {
              if (showForm) {
      ...
      {variants.length > 0 && (
        <div className="mt-6 grid grid-cols-3 gap-4">
          <div className="bg-surface-1/60 rounded-lg p-4 border border-[var(--border)]">
            <div className="text-zinc-400 text-sm mb-1">總獎項數</div>
            <div className="text-2xl font-bold text-white">{variants.length}</div>
          </div>
          <div className="bg-surface-1/60 rounded-lg p-4 border border-[var(--border)]">
            <div className="text-zinc-400 text-sm mb-1">總庫存</div>
            <div className="text-2xl font-bold text-amber-400">
              {variants.reduce((sum, v) => sum + v.stock, 0)}
            </div>
          </div>
          <div className="bg-surface-1/60 rounded-lg p-4 border border-[var(--border)]">
            <div className="text-zinc-400 text-sm mb-1">啟用中</div>
