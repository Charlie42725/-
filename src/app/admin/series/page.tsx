    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-400">管理品牌下的商品系列</p>
        </div>
        <button
        ...
        <div className="bg-surface-1/60 rounded-lg p-6 border border-[var(--border)] mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-zinc-300 mb-2">系列名稱 *</label>
                <input
                  type="text"
                  required
                  value={formData.name}
            ...
            <div>
              <label className="block text-zinc-300 mb-2">系列描述</label>
              <textarea
        ...
        <table className="w-full">
          <thead className="bg-surface-deep">
            <tr>
              ...
              <th className="text-left px-6 py-4 text-zinc-300 font-medium">系列名稱</th>
              ...
              <th className="text-left px-6 py-4 text-zinc-300 font-medium">商品數</th>
            ...
            {series.length === 0 ? (
              ...
              series.map((s) => (
                <tr key={s.id} className="hover:bg-white/[0.04] transition-colors">
                  <td className="px-6 py-4 text-zinc-300">{s.id}</td>
                  <td className="px-6 py-4">
                    <div className="font-medium text-white">{s.name}</div>
                    {s.description && (
                      <div className="text-sm text-zinc-400 mt-1 max-w-xs truncate">
                        {s.description}
                      </div>
                    )}
                  </td>
