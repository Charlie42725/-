  ...
  return (
    <div className="text-center py-12 px-4">
      <div className="bg-zinc-800/50 rounded-3xl p-8 md:p-12 backdrop-blur-sm border border-zinc-700/50 max-w-lg mx-auto">
        ...
        <div className="bg-zinc-900/50 rounded-xl p-4 mb-6 mt-6">
        ...
        <button
          onClick={onLeave}
          className="bg-zinc-700 text-zinc-300 font-medium py-3 px-8 rounded-xl hover:bg-zinc-600 transition-colors"
        >
          離開排隊
        </button>
      </div>
